...
namespace MoviesManagement.Controllers
{
    public class MoviesController : Controller
    {
        ...
        {
            var movieDbContext = _context.Movies.Include(m => m.Author).Include(m => m.Genre);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Year,Description,GenreId,AuthorId")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
